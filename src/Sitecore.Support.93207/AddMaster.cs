                    ...
                    if (args.HasResult)
                    {
                        ...
                        try
                        {
                            if (item.TemplateID == TemplateIDs.BranchTemplate)
                            {
                                ...
                                item3 = Context.Workflow.AddItem(args.Result, branchItem, item2);
                            ...
                            else
                            {
                                ...
                                item3 = Context.Workflow.AddItem(args.Result, templateItem, item2);
                                Log.Audit(this, "Add from template: {0}", new string[]
                                {
                                    AuditFormatter.FormatItem(templateItem)
                                });
                            }
                        }
